...
enum
{
	FROM_HEADER = 0, SUBJECT_HEADER, RECD_HEADER, 
};
...
void HandleAnySpecialEmailMessageEvents(INT32 iMessageId)
{
	...
	switch (iMessageId)
	{
		...
		case (IMP_EMAIL_AGAIN): SetBookMark(IMP_BOOKMARK);
		break;
		case (IMP_EMAIL_INTRO): SetBookMark(IMP_BOOKMARK);
		break;
	}
}
...
BOOLEAN HandleMailSpecialMessages(UINT16 usMessageId, INT32 *iResults, EmailPtr pMail)
{
	...
	switch (usMessageId)
	{
		...
		break;
		case (MERC_INTRO): SetBookMark(MERC_BOOKMARK);
		fReDrawScreenFlag = TRUE;
		break;
...
void HandleIMPCharProfileResultsMessage(void)
{
	...
	if (!pTempRecord)
	{
		...
		{
			// normal as can be
			case (NO_PERSONALITYTRAIT): iOffSet = IMP_PERSONALITY_NORMAL;
			break;
			case (HEAT_INTOLERANT): iOffSet = IMP_PERSONALITY_HEAT;
			break;
			case (NERVOUS): iOffSet = IMP_PERSONALITY_NERVOUS;
			break;
			case (CLAUSTROPHOBIC): iOffSet = IMP_PERSONALITY_CLAUSTROPHOBIC;
			break;
			case (NONSWIMMER): iOffSet = IMP_PERSONALITY_NONSWIMMER;
			break;
			case (FEAR_OF_INSECTS): iOffSet = IMP_PERSONALITY_FEAR_OF_INSECTS;
			break;
			case (FORGETFUL): iOffSet = IMP_PERSONALITY_FORGETFUL;
			break;
			case (PSYCHO): iOffSet = IMP_PERSONALITY_PSYCHO;
			break;
		}
		...
		switch (gMercProfiles[iCurrentIMPSlot].bAttitude)
		{
			...
			break;
			case (ATT_FRIENDLY): iOffSet = IMP_ATTITUDE_FRIENDLY;
			break;
			case (ATT_LONER): iOffSet = IMP_ATTITUDE_LONER;
			break;
			case (ATT_OPTIMIST): iOffSet = IMP_ATTITUDE_OPTIMIST;
			break;
			case (ATT_PESSIMIST): iOffSet = IMP_ATTITUDE_PESSIMIST;
			break;
			case (ATT_AGGRESSIVE): iOffSet = IMP_ATTITUDE_AGGRESSIVE;
			break;
			case (ATT_ARROGANT): iOffSet = IMP_ATTITUDE_ARROGANT;
			break;
			case (ATT_ASSHOLE): iOffSet = IMP_ATTITUDE_ASSHOLE;
			break;
			case (ATT_COWARD): iOffSet = IMP_ATTITUDE_COWARD;
			break;
		...
		{
			case (0): iOffSet = IMP_PORTRAIT_MALE_1;
			break;
			case (1): iOffSet = IMP_PORTRAIT_MALE_2;
			break;
			case (2): iOffSet = IMP_PORTRAIT_MALE_3;
			break;
			case (3): iOffSet = IMP_PORTRAIT_MALE_4;
			break;
			case (4): case (5): iOffSet = IMP_PORTRAIT_MALE_5;
			break;
			case (6): case (7): iOffSet = IMP_PORTRAIT_MALE_6;
			break;
			case (8): iOffSet = IMP_PORTRAIT_FEMALE_1;
			break;
			case (9): iOffSet = IMP_PORTRAIT_FEMALE_2;
			break;
			case (10): iOffSet = IMP_PORTRAIT_FEMALE_3;
			break;
			case (11): case (12): iOffSet = IMP_PORTRAIT_FEMALE_4;
			break;
			case (13): case (14): iOffSet = IMP_PORTRAIT_FEMALE_5;
			break;
		}
