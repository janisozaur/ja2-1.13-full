...
((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 63,
75,//10
100,


((SCREEN_WIDTH - 640) / 2) + 111 + 14,
((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 226,
468,		
27,//15

((SCREEN_WIDTH - 640) / 2) + 111 + 60,
((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 314 - (27),//Previously FLOWER_ORDER_SMALLER_PS_OFFSET_Y

27,

((SCREEN_WIDTH - 640) / 2) + 111 + 205,
((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 143,//20
252,
20,
...
((SCREEN_WIDTH - 640) / 2) + 111 + 124,//25
((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 364,

((SCREEN_WIDTH - 640) / 2) + 111 + 215,
(((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 364),//Previously FLOWER_ORDER_SEND_BUTTON_Y

((SCREEN_WIDTH - 640) / 2) + 111 + 305,
(((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 364),//Previously FLOWER_ORDER_SEND_BUTTON_Y //30

((SCREEN_WIDTH - 640) / 2) + 111 + 94,
((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 68,

(((SCREEN_WIDTH - 640) / 2) + 111 + 94),//Previously FLOWER_ORDER_FLOWER_NAME_X
(((SCREEN_HEIGHT - 480) / 2) + 27 + 68) + 19 + 15,//Previously FLOWER_ORDER_FLOWER_NAME_Y

(((SCREEN_WIDTH - 640) / 2) + 111 + 94),//Previously FLOWER_ORDER_BOUQUET_NAME_X //35
(((SCREEN_HEIGHT - 480) / 2) + 27 + 68) + 19 + 15,//Previously FLOWER_ORDER_FLOWER_NAME_Y

(((SCREEN_WIDTH - 640) / 2) + 111 + 94),//Previously FLOWER_ORDER_FLOWER_NAME_X
((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 126,

(((SCREEN_WIDTH - 640) / 2) + 111 + 94),//Previously FLOWER_ORDER_FLOWER_NAME_X
(((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 143) + 4,//Previously FLOWER_ORDER_DELIVERY_LOcATION_Y //40

(((SCREEN_WIDTH - 640) / 2) + 111 + 7),//Previously FLOWER_ORDER_FLOWER_BOX_X
((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 167,

(((SCREEN_WIDTH - 640) / 2) + 111 + 7),//Previously FLOWER_ORDER_ADDITIONAL_SERVICES_X
((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 212,

(((SCREEN_WIDTH - 640) / 2) + 111 + 14) + 5,//Previously FLOWER_ORDER_SENTIMENT_BOX_X //45
(((SCREEN_HEIGHT - 480) / 2) + 27 + 226) + 19 + 5,//Previously FLOWER_ORDER_SENTIMENT_BOX_Y
457,
17,

(((SCREEN_WIDTH - 640) / 2) + 111 + 7),//Previously FLOWER_ORDER_ADDITIONAL_SERVICES_X
((SCREEN_HEIGHT - 480) / 2) + 27 + 296 + 19 - (27),//Previously FLOWER_ORDER_SMALLER_PS_OFFSET_Y //50

(((SCREEN_WIDTH - 640) / 2) + 111 + 7),//Previously FLOWER_ORDER_ADDITIONAL_SERVICES_X
(((SCREEN_HEIGHT - 480) / 2) + 27 + 314 + 19 - (27))+4,//Previously FLOWER_ORDER_NAME_BOX_Y
50,

(((SCREEN_WIDTH - 640) / 2) + 111 + 60) + 3,//Previously FLOWER_ORDER_NAME_BOX_X
(((SCREEN_HEIGHT - 480) / 2) + 27 + 314 + 19 - (27)) + 3,//Previously FLOWER_ORDER_NAME_BOX_Y //55
257,
15,
...
((SCREEN_WIDTH - 640) / 2) + 111 + 186, //60
(((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 126)	- 3,//Previously FLOWER_ORDER_DATE_Y

((SCREEN_WIDTH - 640) / 2) + 111 + 270,
((((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 126)	- 3),//Previously FLOWER_ORDER_CHECK_BOX_0_Y

((SCREEN_WIDTH - 640) / 2) + 111 + 123,
(((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 167),//Previously FLOWER_ORDER_ADDITIONAL_SERVICES_Y

((SCREEN_WIDTH - 640) / 2) + 111 + 269,
((((SCREEN_HEIGHT - 480) / 2) + 27 + 19 + 167)),//Previously FLOWER_ORDER_CHECK_BOX_2_Y

(((SCREEN_WIDTH - 640) / 2) + 111 + 123),//Previously FLOWER_ORDER_CHECK_BOX_2_X
((((SCREEN_HEIGHT - 480) / 2) + 27 + 167)) + 19 + 25,//Previously FLOWER_ORDER_CHECK_BOX_2_Y

((((SCREEN_WIDTH - 640) / 2) + 111 + 123)),//Previously FLOWER_ORDER_CHECK_BOX_3_X
(((((SCREEN_HEIGHT - 480) / 2) + 27 + 167)) + 19 + 25),//Previously FLOWER_ORDER_CHECK_BOX_4_Y

((SCREEN_WIDTH - 640) / 2) + 111 + 190,
((SCREEN_HEIGHT - 480) / 2) + 27 + 284 + 19 - (27),//Previously FLOWER_ORDER_SMALLER_PS_OFFSET_Y

(((SCREEN_WIDTH - 640) / 2) + 111 + 205),//Previously FLOWER_ORDER_DELIVERY_LOCATION_X
(((SCREEN_HEIGHT - 480) / 2) + 27 + 143) + 19 + 19,//Previously FLOWER_ORDER_DELIVERY_LOCATION_Y
230,

(((SCREEN_WIDTH - 640) / 2) + 111 + 205) + 5,//Previously FLOWER_ORDER_DROP_DOWN_LOCATION_X
(((SCREEN_HEIGHT - 480) / 2) + 27 + 143) + 19 + 3,//Previously FLOWER_ORDER_DROP_DOWN_LOCATION_Y
