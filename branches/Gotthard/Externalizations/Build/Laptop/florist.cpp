...
BOOLEAN EnterFlorist()
{
  VOBJECT_DESC    VObjectDesc;
	...
	guiGalleryButton = CreateIconAndTextButton( guiGalleryButtonImage, sFloristText[FLORIST_GALLERY], iFloristConstants[FLORIST_BUTTON_TEXT_FONT], 
													 ...
													 TEXT_CJUSTIFIED, 
													 iFloristConstants[FLORIST_GALLERY_BUTTON_X], iFloristConstants[FLORIST_GALLERY_BUTTON_Y], BUTTON_TOGGLE, MSYS_PRIORITY_HIGH,
...
BOOLEAN InitFloristDefaults()
{
  VOBJECT_DESC    VObjectDesc;
	...
	else
	{
		...
		MSYS_DefineRegion( &gSelectedFloristTitleHomeLinkRegion, iFloristConstants[FLORIST_SMALL_TITLE_X], iFloristConstants[FLORIST_SMALL_TITLE_Y], (UINT16)(iFloristConstants[FLORIST_SMALL_TITLE_X] + iFloristConstants[FLORIST_SMALL_TITLE_WIDTH]), (UINT16)(iFloristConstants[FLORIST_SMALL_TITLE_Y] + iFloristConstants[FLORIST_SMALL_TITLE_HEIGHT]), MSYS_PRIORITY_HIGH,
...
void DisplayFloristDefaults()
{
  HVOBJECT hPixHandle;
	...
	WebPageTileBackground(4, 4, iFloristConstants[FLORIST_BACKGROUND_WIDTH], iFloristConstants[FLORIST_BACKGROUND_HEIGHT], guiFloristBackground);
	...
	if( guiCurrentLaptopMode == LAPTOP_MODE_FLORIST )
	{
		...
		BltVideoObject(FRAME_BUFFER, hPixHandle, 0,iFloristConstants[FLORIST_BIG_TITLE_X], iFloristConstants[FLORIST_BIG_TITLE_Y], VO_BLT_SRCTRANSPARENCY,NULL);
	}
	else
	{
		gfHomePageActive = FALSE;		
		GetVideoObject(&hPixHandle, guiSmallTitleSymbol);
		BltVideoObject(FRAME_BUFFER, hPixHandle, 0,iFloristConstants[FLORIST_SMALL_TITLE_X], iFloristConstants[FLORIST_SMALL_TITLE_Y], VO_BLT_SRCTRANSPARENCY,NULL);
	}
}
