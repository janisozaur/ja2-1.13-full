...
BP_PER_AP_HVY_EFFORT
BP_PER_AP_MAX_EFFORT
...
//Just so the compiler will be able to use it in init.cpp, I'm a careful person.  gottahrd 1/18/07
extern INT16 iAPBPConstants[180] = {0};
