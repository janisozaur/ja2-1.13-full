...
typedef struct
{
	...
	INT16		ubShopKeeperID;					// Merc Id for the dealer
...
typedef struct
{
	...
	INT16		ubImprintID;					// imprint ID for imprinted items (during repair!)
...
typedef struct
{
	...
	INT16 ubOwnerProfileId;			// stores which merc previously owned an item being repaired
