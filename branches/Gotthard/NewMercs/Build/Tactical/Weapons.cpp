...
BOOLEAN UseThrown( SOLDIERTYPE *pSoldier, INT32 sTargetGridNo )
{
	...
	if ( GetDirectionFromGridNo( sTargetGridNo, pSoldier ) != pSoldier->bDirection )
...
BOOLEAN DoSpecialEffectAmmoMiss( INT16 ubAttackerID, INT32 sGridNo, INT16 sXPos, INT16 sYPos, INT16 sZPos, BOOLEAN fSoundOnly, BOOLEAN fFreeupAttacker, INT32 iBullet )
{
...
void WeaponHit( INT16 usSoldierID, UINT16 usWeaponIndex, INT16 sDamage, INT16 sBreathLoss, INT8 usDirection, INT16 sXPos, INT16 sYPos, INT16 sZPos, INT16 sRange , INT16 ubAttackerID, BOOLEAN fHit, UINT8 ubSpecial, UINT8 ubHitLocation )
{
...
void StructureHit( INT32 iBullet, UINT16 usWeaponIndex, INT8 bWeaponStatus, INT16 ubAttackerID, UINT16 sXPos, INT16 sYPos, INT16 sZPos, UINT16 usStructureID, INT32 iImpact, BOOLEAN fStopped )
{
...
void WindowHit( INT32 sGridNo, INT16 usStructureID, BOOLEAN fBlowWindowSouth, BOOLEAN fLargeForce )
{
...
void ShotMiss( INT16 ubAttackerID, INT32 iBullet )
{
	BOOLEAN						fDoMissForGun = FALSE;
