...
BOOLEAN AdjustToNextAnimationFrame( SOLDIERTYPE *pSoldier )
{
	...
	do
	{
		...
		//ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"sNewAniFrame: %d", sNewAniFrame );
		...
		else if ( sNewAniFrame < 500 )
		{
			...
			case 430:
				...
				//ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"AdjustToNextAnimationFrame: case 430");
				// SHOOT GUN
