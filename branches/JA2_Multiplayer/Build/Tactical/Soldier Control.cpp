...
{
	//ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"EVENT_InitNewSoldierAnim");
	...
	/////////////////////////////////////////////////////////////////////
	//ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"made decision" );
...
BOOLEAN EVENT_InternalGetNewSoldierPath( SOLDIERTYPE *pSoldier, UINT16 sDestGridNo, UINT16 usMovementAnim, BOOLEAN fFromUI, BOOLEAN fForceRestartAnim )
{
	...
	//ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"Soldier Control.cpp: EVENT_InternalGetNewSoldierPath" );
...
BOOLEAN ConvertAniCodeToAniFrame( SOLDIERTYPE *pSoldier, UINT16 usAniFrame )
{
	...
	if ( pSoldier->usAniFrame >= gAnimSurfaceDatabase[ usAnimSurface ].hVideoObject->usNumberOfObjects )
	{
		// Debug msg here....
		//		
( FONT_MCOLOR_LTYELLOW, MSG_BETAVERSION, L"Soldier Animation: Wrong Number of frames per number of objects: %d vs %d, %S",  gAnimSurfaceDatabase[ usAnimSurface ].uiNumFramesPerDir, gAnimSurfaceDatabase[ usAnimSurface ].hVideoObject->usNumberOfObjects, gAnimControl[ pSoldier->usAnimState ].zAnimStr );	
...
void TurnSoldier( SOLDIERTYPE *pSoldier)
{
	...
	if ( pSoldier->fTurningToShoot )
	{
		if ( pSoldier->bDirection == pSoldier->bDesiredDirection )
		{
			...
			{
				//ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"TurnSoldier: EVENT_InitNewSoldierAnim" );
				EVENT_InitNewSoldierAnim( pSoldier, SelectFireAnimation( pSoldier, gAnimControl[ pSoldier->usAnimState ].ubEndHeight ), 0, FALSE );
...
void MoveMerc( SOLDIERTYPE *pSoldier, FLOAT dMovementChange, FLOAT dAngle, BOOLEAN fCheckRange )
{
	...
	//ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"X: %f Y: %f", dXPos, dYPos );
...
void SendSoldierPositionEvent( SOLDIERTYPE *pSoldier, FLOAT dNewXPos, FLOAT dNewYPos )
{
	...
	ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"SendSoldierPositionEvent" );
...
{
	// Sent event for position update
	ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"SendSoldierDestinationEvent" );
...
{
	// Sent event for position update
	ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"SendSoldierSetDirectionEvent" );
...
{
	// Sent event for position update
	//ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"SendSoldierSetDesiredDirectionEvent" );
...
{
	//ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"SendGetNewSoldierPathEvent" );
...
void SendChangeSoldierStanceEvent( SOLDIERTYPE *pSoldier, UINT8 ubNewStance )
{
	...
	ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"SendChangeSoldierStanceEvent" );
#ifdef NETWORKED
...
void SendBeginFireWeaponEvent( SOLDIERTYPE *pSoldier, INT16 sTargetGridNo )
{
	...
	//ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"targetgridno. : %d", SBeginFireWeapon.sTargetGridNo );
