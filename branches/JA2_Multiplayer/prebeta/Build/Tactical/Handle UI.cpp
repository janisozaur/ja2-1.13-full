...
UINT32 UIHandleCMoveMerc( UI_EVENT *pUIEvent )
{
	...
	//ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"Handle UI.cpp: UIHandleCMoveMerc" );
	if ( gusSelectedSoldier != NO_SOLDIER )
	{
...

{
	...
	//ScreenMsg( FONT_MCOLOR_LTYELLOW, MSG_INTERFACE, L"Handle UI.cpp: UIHandleSoldierStanceChange" );
