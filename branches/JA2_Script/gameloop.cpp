...
Ja2::Scripting::ScriptHost* gpScriptHostObj; // Dealtar: required for scripting system
...
BOOLEAN InitializeGame(void)
{
	...
	// Scripting system
	gpScriptHostObj = new Ja2::Scripting::ScriptHost(&guiCurrentScreen, &gfGamePaused);
