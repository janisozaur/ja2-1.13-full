...
BOOLEAN ExecuteGameEvent( EVENT *pEvent )
{
	...
	//pDebug = fopen("events.log", "a+t");
	//fprintf(pDebug, "ExecuteGameEvent\n");
	//fprintf(pDebug, "Event = %d\n", pEvent->uiEvent);
	//fprintf(pDebug, "Flags = %08X\n", pEvent->TimeStamp);
	//fprintf(pDebug, "Size  = %d\n", pEvent->uiDataSize);
	//if (pEvent->uiEvent == S_NOISE )
	//{
	//	fprintf(pDebug, "Noisemaker = %d\n", ((EV_S_NOISE*)pEvent->pData)->ubNoiseMaker);
	//}
	//fprintf(pDebug, "\n");
	//fclose(pDebug);
