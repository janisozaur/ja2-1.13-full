...
#ifdef _DEBUG
		mprintf( 10, 10, L"%ls: %ls Debug %hs", pMessageStrings[ MSG_VERSION ], zVersionLabel, czVersionNumber );
#else
		mprintf( 10, 10, L"%ls: %ls %hs", pMessageStrings[ MSG_VERSION ], zVersionLabel, czVersionNumber );
#endif
