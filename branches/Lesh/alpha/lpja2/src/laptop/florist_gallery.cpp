...
//	usPosX = FLOR_GALLERY_FLOWER_BUTTON_X;
	...
	{
		guiGalleryButtons[j] = QuickCreateButton( guiGalleryButtonImage, FLOR_GALLERY_FLOWER_BUTTON_X, usPosY,
...
BOOLEAN DisplayFloralDescriptions()
{
	...
	for(i=0; i<gubCurNumberOfFlowers; i++)
	{
		...
		WSTR_SPrintf( sTemp, 640, L"$%d.00 %ls", usPrice, pMessageStrings[ MSG_USDOLLAR_ABBREVIATION ] );
