...
// Lesh: test the particles
extern void CreateParticles( INT16 sGridNo, UINT8 ubLevel );
...
void GenerateExplosionFromExplosionPointer( EXPLOSIONTYPE *pExplosion )
{
  ...
  if ( sZ == 0 && bLevel > 0 )
  {
	...
	//CreateParticles(pExplosion->Params.sGridNo, pExplosion->Params.bLevel);
}
