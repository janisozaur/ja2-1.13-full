...
STR16	zNewTacticalMessages[]=
{
	...
	L"You cannot afford to hire %ls",
	L"For a limited time, the above fee covers the cost of the entire mission and includes the equipment listed below.",
	L"Hire %ls now and take advantage of our unprecedented 'one fee covers all' pricing.  Also included in this unbelievable offer is the mercenary's personal equipment at no charge.",
	L"Fee",
	...
	L"%ls hears the sound of crumpling metal coming from underneath Jerry's body.  It sounds disturbingly like your laptop antenna being crushed.",  //the %ls is the name of a merc.  @@@  Modified
	L"After scanning the note left behind by Deputy Commander Morris, %ls senses an oppurtinity.  The note contains the coordinates for launching missiles against different towns in Arulco.  It also gives the coodinates of the origin - the missile facility.",
	L"Noticing the control panel, %ls figures the numbers can be reveresed, so that the missile might destroy this very facility.  %ls needs to find an escape route.  The elevator appears to offer the fastest solution...",
	...
	L"Campaign: Default ( %hs )",																							// @@@ new text
	L"Campaign: %hs",																													// @@@ new text
	L"You have selected the campaign %hs. This campaign is a player-modified version of the original Unfinished Business campaign. Are you sure you wish to play the %hs campaign?",			// @@@ new text
