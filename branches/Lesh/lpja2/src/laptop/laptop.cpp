// WANNE 2 <changed some lines>
	...
	#include "broken_link.h"
	#include "bobby_ray_shipments.h"
#else
	#include "sgp.h"
	#include "utilities.h"
	#include "wcheck.h"
...
void PrintNumberOnTeam( void )
{
  ...
  INT32 cnt=0;
	...
	WSTR_SPrintf( pString, 32, L"%ls %d",pPersonnelString[ 0 ], iCounter );
...
BOOLEAN RenderWWWProgramTitleBar( void )
{
  ...
  // display title
	...
	else
	{
		...
		WSTR_SPrintf( sString, 256, L"%ls  -  %ls", pWebTitle[0], pWebPagesTitles[ iIndex ] );
