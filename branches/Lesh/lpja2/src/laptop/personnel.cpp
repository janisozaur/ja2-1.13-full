		...
		switch(iCounter)
		{
		 case 0:
			 ...
			 if( Menptr[iId].bAssignment != ASSIGNMENT_POW )
			 {
				...
				{
					WSTR_SPrintf(sString, 50, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bLifeDelta);
			 ...
			 //else
			 //{
				 WSTR_SPrintf(sString, 50, L"%d/%d",Menptr[iId].bLife,Menptr[iId].bLifeMax);
			 //}
			 }
			 else
			 {
				 WSTR_SPrintf( sString, 50, pPOWStrings[ 1 ] );
			 }
       ...
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 ...
		 case 1:
			 ...
			 if( !fAmIaRobot )
			 {
				 ...
				 {
					 WSTR_SPrintf(sString, 50, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bAgilityDelta);
					 FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20+TEXT_DELTA_OFFSET ),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 		 mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
					 WSTR_SPrintf(sString, 50, L"%d",Menptr[iId].bAgility);
				 //}
			 }
			 else
			 {
		 ...
		 case 2:
		  // dexterity
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						WSTR_SPrintf(sString, 50, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bDexterityDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20+TEXT_DELTA_OFFSET ),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
				 		WSTR_SPrintf(sString, 50, L"%d",Menptr[iId].bDexterity);
				 //}
			 }
			 else
			 {
       ...
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 ...
		 // strength
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						WSTR_SPrintf(sString, 50, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bStrengthDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20+TEXT_DELTA_OFFSET ),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
				 		WSTR_SPrintf(sString, 50, L"%d",Menptr[iId].bStrength );
				 //}
			 }
			 else
			 {
		 ...
		 case 4:
		  // leadership
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						WSTR_SPrintf(sString, 50, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bLeadershipDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20 +TEXT_DELTA_OFFSET),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
				 		WSTR_SPrintf(sString, 50, L"%d",Menptr[iId].bLeadership );
				 //}
			 }
			 else
			 {
		 ...
		 case 5:
		  // wisdom
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						WSTR_SPrintf(sString, 50, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bWisdomDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20+TEXT_DELTA_OFFSET ),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 
				 }
				 //else
				 //{
				 		WSTR_SPrintf(sString, 50, L"%d",Menptr[iId].bWisdom );
				 //}
			 }
			 else
			 {
		 ...
		 case 6:
		  // exper
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						WSTR_SPrintf(sString, 50, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bExpLevelDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20 +TEXT_DELTA_OFFSET),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);
				 }
				 //else
				 //{
				 		WSTR_SPrintf(sString, 50, L"%d",Menptr[iId].bExpLevel );
				 //}
			 }				
			 else
			 {
       ...
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 ...
		 case 7:
			 ...
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						WSTR_SPrintf(sString, 50, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bMarksmanshipDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20+TEXT_DELTA_OFFSET ),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
				 		WSTR_SPrintf(sString, 50, L"%d",Menptr[iId].bMarksmanship);
				 //}
			 }
			 else
			 {
     ...
     case 8:
		  // mech
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						WSTR_SPrintf(sString, 50, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bMechanicDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20+TEXT_DELTA_OFFSET ),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
					 WSTR_SPrintf(sString, 50, L"%d",Menptr[iId].bMechanical);
				 //}
			 }
			 else
			 {
     ...
     case 9:
		  // exp
			 if( !fAmIaRobot )
			 {
				 ...
				 {
						WSTR_SPrintf(sString, 50, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bExplosivesDelta);
						FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20+TEXT_DELTA_OFFSET ),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 			mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
				 		WSTR_SPrintf(sString, 50, L"%d",Menptr[iId].bExplosive);
				 //}
       ...
       // med
			 if( !fAmIaRobot )
			 {
				 ...
				 {
					 WSTR_SPrintf(sString, 50, L"( %+d )", gMercProfiles[Menptr[iId].ubProfile].bMedicalDelta);
					 FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH) + TEXT_BOX_WIDTH-20 +TEXT_DELTA_OFFSET),0,30,0,sString, PERS_FONT,  &sX, &sY);
			 		 mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);			 }
				 //else
				 //{
				 		WSTR_SPrintf(sString, 50, L"%d",Menptr[iId].bMedical);
				 //}
			 }
			 else
			 {
      ...
      mprintf((INT16)(pPersonnelScreenPoints[21].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[21].y,pPersonnelScreenStrings[PRSNL_TXT_KILLS]);		 
			WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[Menptr[iId].ubProfile].usKills);
      ...
      mprintf(sX,pPersonnelScreenPoints[21].y,sString);
		 ...
		 case 15:
			...
			WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[Menptr[iId].ubProfile].usAssists);
      ...
      mprintf(sX,pPersonnelScreenPoints[22].y,sString);
		 break;
		  case 16:
			...
			WSTR_SPrintf(sString, 50, L"%d %%%%",uiHits);
      ...
      sX += StringPixLength( L"%",  PERS_FONT );
		 ...
		 break;
		  case 17:
			...
			WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[Menptr[iId].ubProfile].usBattlesFought);
      ...
      mprintf(sX,pPersonnelScreenPoints[24].y,sString);
		 ...
		 case 18:
			...
			WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[Menptr[iId].ubProfile].usTimesWounded);
...
void DrawPageNumber( void )
{
  ...
  iPageNumber++;
	...
	WSTR_SPrintf(sString, 10, L"%d/%d", iPageNumber, iLastPage);
		...
		if( pSoldier->inv[ ubCounter ].ubNumberOfObjects )
		{
			...
			else
			{
				...
				if ( Item[pSoldier->inv[ ubCounter ].usItem ].usItemClass & IC_AMMO )
				{
					...
					WSTR_SPrintf( sString, 128, L"%d/%d", iTotalAmmo, ( pSoldier->inv[ ubCounter ].ubNumberOfObjects * Magazine[ Item[pSoldier->inv[ ubCounter ].usItem ].ubClassIndex ].ubMagSize ) );
				...
				{
						WSTR_SPrintf( sString, 128, L"%2d%%%%", pSoldier->inv[ ubCounter ].bStatus[0] );
						FindFontRightCoordinates( ( INT16 )( PosX + 65 ), ( INT16 ) ( PosY + 15 ), ( INT16 ) ( 171 - 75 ), 
							( INT16 )( GetFontHeight( FONT10ARIAL ) ), sString, FONT10ARIAL, &sX, &sY );
				...
				if( pSoldier->inv[ ubCounter ].ubNumberOfObjects > 1 )
				{
					WSTR_SPrintf( sString, 128, L"x%d",  pSoldier->inv[ ubCounter ].ubNumberOfObjects );
...
void DisplayCostOfCurrentTeam( void )
{
	...
	if( fCurrentTeamMode == TRUE )
	{
	  ...
	  WSTR_SPrintf( sString, 32, L"%d", GetTotalDailyCostOfCurrentTeam( ) );
	  ...
	  WSTR_SPrintf( sString, 32, L"%d", GetHighestDailyCostOfCurrentTeam( ) );
		InsertCommasForDollarFigure( sString );
		InsertDollarSignInToString( sString );
	  ...
	  WSTR_SPrintf( sString, 32, L"%d", GetLowestDailyCostOfCurrentTeam( ) );
		InsertCommasForDollarFigure( sString );
		InsertDollarSignInToString( sString );
...
void DisplayAverageStatValuesForCurrentTeam( void )
{
  ...
  if( ( GetNumberOfMercsDeadOrAliveOnPlayersTeam( ) == 0 ) && (  fCurrentTeamMode == TRUE ) )
	...
	for( iCounter = 0; iCounter < 11; iCounter++ )
	{
		...
		{
			WSTR_SPrintf( sString, 32, L"%d", GetAvgStatOfPastTeamStat( iCounter ) );
		}
		// center
...
void DisplayStateOfPastTeamMembers( void )
{
	...
	if( fCurrentTeamMode == FALSE )
	{
	   ...
	   mprintf(  PERS_CURR_TEAM_COST_X, PERS_CURR_TEAM_COST_Y, pPersonelTeamStrings[ 5 ] );
		 WSTR_SPrintf( sString, 32, L"%d", GetNumberOfDeadOnPastTeam( ) );
		 ...
		 mprintf(  PERS_CURR_TEAM_COST_X, PERS_CURR_TEAM_HIGHEST_Y, pPersonelTeamStrings[ 6 ] );
	   	WSTR_SPrintf( sString, 32, L"%d", GetNumberOfLeftOnPastTeam( ) );
		 ...
		 WSTR_SPrintf( sString, 32, L"%d", GetNumberOfOtherOnPastTeam( ) );
	...
	for(iCounter=0;iCounter <MAX_STATS; iCounter++)
	{
		switch(iCounter)
		{
		 case 0:
			 ...
			 if( iState == 0 )
			 {
			   WSTR_SPrintf(sString, 50, L"%d/%d",0,gMercProfiles[iId].bLife);
			 }
			 else
			 {
				 WSTR_SPrintf(sString, 50, L"%d/%d",gMercProfiles[iId].bLife,gMercProfiles[iId].bLife);
			 }
       ...
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 ...
		 case 1:
			 // agility
       WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[iId].bAgility);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		 
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
			 break;
		 case 2:
		  // dexterity
       WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[iId].bDexterity);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
			break;
		 case 3:
		 // strength
       WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[iId].bStrength);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 break;
		 case 4:
		  // leadership
       WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[iId].bLeadership);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 break;
		 case 5:
		  // wisdom
       WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[iId].bWisdom);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 break;
		 case 6:
		  // exper
       WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[iId].bExpLevel);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 break;
		 case 7:
			 //mrkmanship
       WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[iId].bMarksmanship);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 break;
     case 8:
		  // mech
       WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[iId].bMechanical);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 break;
     case 9:
		  // exp
       WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[iId].bExplosive);
       mprintf((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[iCounter].y,pPersonnelScreenStrings[iCounter]);		
		   FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[iCounter].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
       mprintf(sX,pPersonnelScreenPoints[iCounter].y,sString);		 
		 break;
       ...
       WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[iId].bMedical);
		 ...
		 // kills
      mprintf((INT16)(pPersonnelScreenPoints[21].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[21].y,pPersonnelScreenStrings[PRSNL_TXT_KILLS]);		 
			WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[iId].usKills);
      FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[21].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
      mprintf(sX,pPersonnelScreenPoints[21].y,sString);
		 break;
		 case 15:
			// assists
			mprintf((INT16)(pPersonnelScreenPoints[22].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[22].y,pPersonnelScreenStrings[PRSNL_TXT_ASSISTS]);		 
			WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[iId].usAssists);
      FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[22].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
      mprintf(sX,pPersonnelScreenPoints[22].y,sString);
		 break;
		  case 16:
      ...
      sX += StringPixLength( L"%",  PERS_FONT );
		 ...
		 break;
		  case 17:
			// battles
			mprintf((INT16)(pPersonnelScreenPoints[24].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[24].y,pPersonnelScreenStrings[PRSNL_TXT_BATTLES]);
			WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[iId].usBattlesFought);
      FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[24].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
      mprintf(sX,pPersonnelScreenPoints[24].y,sString);
		 break;
		 case 18:
			// wounds
			mprintf((INT16)(pPersonnelScreenPoints[25].x+(iSlot*TEXT_BOX_WIDTH)),pPersonnelScreenPoints[25].y,pPersonnelScreenStrings[PRSNL_TXT_TIMES_WOUNDED]);
			WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[iId].usTimesWounded);
      FindFontRightCoordinates((INT16)(pPersonnelScreenPoints[25].x+(iSlot*TEXT_BOX_WIDTH)),0,TEXT_BOX_WIDTH-20,0,sString, PERS_FONT,  &sX, &sY);
      mprintf(sX,pPersonnelScreenPoints[25].y,sString);
		 break;
		}
							...
							else if( fATMFlags == 2 )
							{
								...
								if( GetFundsOnMerc( pSoldier ) >= wcstol( sTransferString, NULL, 10 ) )
								{
									if( ( wcstol( sTransferString, NULL, 10 ) % 10 ) != 0 )
									{
										...
										WSTR_SPrintf( sTransferString, 32, L"%d", iValue );
										fReDrawScreenFlag=TRUE;
									}
									else
									{
...
void DisplayAmountOnCurrentMerc( void )
{
	...
	WSTR_SPrintf( sString, 64, L"%d", iFunds );
...
*/
				WSTR_SPrintf( sString, 50, L"%d", gMercProfiles[ Menptr[ iId ].ubProfile ].uiTotalCostToDate );
		 ...
		 case 5:
		   // medical deposit		 
			...
			if( Menptr[iId].ubWhatKindOfMercAmI == MERC_TYPE__MERC )
			{
				...
				WSTR_SPrintf( sString, 50, L"%d", gMercProfiles[Menptr[ iId ].ubProfile].sSalary * gMercProfiles[Menptr[ iId ].ubProfile ].iMercMercContractLength );
				InsertCommasForDollarFigure( sString );
				InsertDollarSignInToString( sString );
			...
			else
			{
				...
				WSTR_SPrintf(sString, 50, L"%d",gMercProfiles[Menptr[iId].ubProfile].sMedicalDepositAmount);
