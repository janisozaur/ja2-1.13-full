...
//	{
		if ( VObjectDesc->fCreateFlags & VOBJECT_CREATE_FROMFILE || VObjectDesc->fCreateFlags & VOBJECT_CREATE_FROMHIMAGE )
		{
			if ( VObjectDesc->fCreateFlags & VOBJECT_CREATE_FROMFILE )
			{
				...
				{
						MemFree( hVObject );
						fprintf(stderr, "VOBJECT: Invalid image filename given (%s)\n", VObjectDesc->ImageFile );
			...
			{ // create video object from provided hImage
				...
				{
						MemFree( hVObject );
						fprintf(stderr, "VOBJECT: Invalid hImage pointer given\n" );
			...
			{
					MemFree( hVObject );
					fprintf(stderr, "VOBJECT: Invalid Image format given\n" );
	...
	//		break;
		...
		{
			MemFree( hVObject );
			fprintf(stderr, "VOBJECT: Invalid VObject creation flags given\n" );
