...
typedef struct
{
	...
	UINT32		TransparentColor;			// Defaults to 0,0,0
...
// Creates and adds a video Surface to list
	...
	extern BOOLEAN _AddAndRecordVSurface( VSURFACE_DESC *VSurfaceDesc, UINT32 *uiIndex, UINT32 uiLineNum, const CHAR8 *pSourceFile );
