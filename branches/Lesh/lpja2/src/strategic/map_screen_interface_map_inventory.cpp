...
extern BOOLEAN ReduceStringLength( STR16 pString, UINT16 usMaxLen, UINT32 uiWidthToFitIn, UINT32 uiFont );
...
BOOLEAN RenderItemInPoolSlot( INT32 iCurrentSlot, INT32 iFirstSlotOnPage )
{
  ...
  INVRenderItem( guiSAVEBUFFER, NULL, &(pInventoryPoolList[ iCurrentSlot + iFirstSlotOnPage ].o), 
	...
	{
		ReduceStringLength( sString, 64, ( INT16 )( MAP_INVEN_SLOT_WIDTH - StringPixLength( L" ...", MAP_IVEN_FONT ) ), MAP_IVEN_FONT );
	}
