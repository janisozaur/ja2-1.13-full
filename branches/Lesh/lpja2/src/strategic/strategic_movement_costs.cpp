...
MOVEMENT_INFO	MovementInfo[ TOTAL_SECTORS ];
...
BOOLEAN InitStrategicMovementCosts()
{
	...
	for ( cnt = 0; cnt < TOTAL_SECTORS; cnt++ )
	{
		SectorInfo[ cnt ].ubTravelRating = MovementInfo[ cnt ].travRating;
		SectorInfo[ cnt ].ubTraversability[ NORTH_STRATEGIC_MOVE   ] = MovementInfo[ cnt ].travNorth;
		SectorInfo[ cnt ].ubTraversability[ EAST_STRATEGIC_MOVE    ] = MovementInfo[ cnt ].travEast;
		SectorInfo[ cnt ].ubTraversability[ SOUTH_STRATEGIC_MOVE   ] = MovementInfo[ cnt ].travSouth;
		SectorInfo[ cnt ].ubTraversability[ WEST_STRATEGIC_MOVE    ] = MovementInfo[ cnt ].travWest;
		SectorInfo[ cnt ].ubTraversability[ THROUGH_STRATEGIC_MOVE ] = MovementInfo[ cnt ].travHere;
	}
	//InitStrategicRowA();
	//InitStrategicRowB();
	//InitStrategicRowC();
