...
wchar_t Message[][STRING_LENGTH] =
{
	...
	L"You cannot use your %ls and your %ls at the same time.",
	...
	L"%ls failed to grab the %ls from enemy's hand!",
...
STR16 pTransactionText[] =
{
	...
	L"Payment to %ls",		// %ls is the name of the npc being paid
...
//21-25
	L"The mine in %ls has been captured by enemy forces!",
	L"Enemy forces have just invaded the SAM site in %ls",
	L"Enemy forces have just invaded %ls",
	L"Enemy forces have just been spotted in %ls.",
	L"Enemy forces have just taken over %ls.",
//26-30
...
STR16 pMercContractOverStrings[] =
{
	...
	L"You owe M.E.R.C. too much cash, so %ls took off.", // Your M.E.R.C. account is invalid so merc left
};
...
STR16			MercAccountText[] = 
{
	...
	L"Charge",
	L"Total:",
	L"Are you sure you want to authorize the payment of %ls?",		//the %ls is a string that contains the dollar amount ( ex. "$150" )
};
...
{
	L"Thank You, %ls", //%ls is the name of the merc
};
...
STR16 pMessageStrings[] =
{
	...
	L"%ls has arrived in sector %ls%ls", //30	Name/Squad has arrived in sector A9.  Order must not change without notifying
																		//SirTech
	L"Version",
	...
	L"%ls has no medical skill",//40	'Merc name' has no medical skill.
	...
	L"%ls passed to %ls.", //"Item" passed to "merc".  Please try to keep the item %ls before the merc %ls, otherwise,
											 //must notify SirTech.
	...
	L"3D Cursor ON.",
	L"Squad %d active.",
	L"You cannot afford to pay for %ls's daily salary of %ls",	//first %ls is the mercs name, the seconds is a string containing the salary
	L"Skip",				// 70
	...
	L"A package has arrived in Drassen.",
 	L"%ls should arrive at the designated drop-off point (sector %ls) on day %d, at approximately %ls.",		//first %ls is mercs name, next is the sector location and name where they will be arriving in, lastely is the day an the time of arrival
...
{
	L"%hs loadscreen data file not found...",
  ...
  L"Are you sure?",
	...
	L"%ls's armour attachment has been smashed!",
	L"%ls fires %d more rounds than intended!",
	L"%ls fires %d more round than intended!",
};
...
STR16 gzTooltipStrings[] =
{
	...
	L"%ls|Location: %d\n",
	L"%ls|Brightness: %d / %d\n",
	L"%ls|Range to |Target: %d\n",
	L"%ls|I|D: %d\n",
	L"%ls|Orders: %d\n",
	L"%ls|Attitude: %d\n",
	L"%ls|Current |A|Ps: %d\n",
	L"%ls|Current |Health: %d\n",
	// Full info
	L"%ls|Helmet: %ls\n",
	L"%ls|Vest: %ls\n",
	L"%ls|Leggings: %ls\n",
	...
	L"%ls|Gas |Mask: %ls\n",
	L"no Gas Mask",
	L"%ls|Head |Position |1: %ls\n",
	L"%ls|Head |Position |2: %ls\n",
	L"\n(in Backpack) ",
	L"%ls|Weapon: %ls ",
	L"no Weapon",
	L"Handgun",
