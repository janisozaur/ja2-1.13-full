...
STR16 pMercContractOverStrings[] =
{
	...
	L"Dovete al M.E.R.C. troppi soldi, così %ls è partito.", // Your M.E.R.C. account is invalid so merc left
};
...
{
	L"%hs file di dati della schermata di caricamento non trovato...",
