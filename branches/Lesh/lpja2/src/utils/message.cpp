...
{
	pStringSt->pString16=(STR16)MemAlloc( (wcslen(pString) + 1) * sizeof(CHAR16) );
...
BOOLEAN CreateStringVideoOverlay( ScrollStringStPtr pStringSt, UINT16 usX, UINT16 usY )
{
	...
	WSTR_SPrintf( VideoOverlayDesc.pzText, VIDEO_OVERLAY_TEXT_LEN, (wchar_t *)pStringSt->pString16 );
...
void ScreenMsg( UINT16 usColor, UINT8 ubPriority, STR16 pStringA, ...)
{
	...
	//{
		...
		WSTR_VSPrintf(DestString, 512, pStringA, argptr);
		va_end(argptr);
