...
void CheckGridNoOfItemsInMapScreenMapInventory()
{
	...
	{
		if( ( pInventoryPoolList[ iCnt ].sGridNo >= MAX_MAP_POS || pInventoryPoolList[ iCnt ].sGridNo == NOWHERE )&& !( pInventoryPoolList[ iCnt ].usFlags & WORLD_ITEM_GRIDNO_NOT_SET_USE_ENTRY_POINT ) )
		{
			//set the flag
	...
	{
		if( ( pUnSeenItems[ iCnt ].sGridNo >= MAX_MAP_POS || pUnSeenItems[ iCnt ].sGridNo == NOWHERE ) && !( pUnSeenItems[ iCnt ].usFlags & WORLD_ITEM_GRIDNO_NOT_SET_USE_ENTRY_POINT ) )
		{
			//set the flag
