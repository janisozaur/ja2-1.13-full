...
INT32 SoldierToLocationLineOfSightTest( SOLDIERTYPE * pStartSoldier, INT32 sGridNo, UINT8 ubSightLimit, INT8 bAware );
INT32 SoldierTo3DLocationLineOfSightTest( SOLDIERTYPE * pStartSoldier, INT32 sGridNo, INT8 bLevel, INT8 bCubeLevel, UINT8 ubSightLimit, INT8 bAware );
...
INT32 SoldierToLocationVisibleDistance( SOLDIERTYPE * pStartSoldier, INT32 sGridNo, UINT8 ubTileSightLimit, INT8 bAware );
